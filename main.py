...
def generate():
    try:
        ...
        result = JavaBusinessRulesDemoCrew().crew().kickoff(inputs=inputs)
...
def train():
    ...
    try:
        ...
        JavaBusinessRulesDemoCrew().crew().train(n_iterations=int(sys.argv[1]), filename=sys.argv[2], inputs=inputs)
...
def replay():
    ...
    """
    try:
        JavaBusinessRulesDemoCrew().crew().replay(task_id=sys.argv[1])
...
def test():
    ...
    try:
        JavaBusinessRulesDemoCrew().crew().test(n_iterations=int(sys.argv[1]), openai_model_name=sys.argv[2], inputs=inputs)
